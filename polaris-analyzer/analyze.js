...
Since you can't watch the video directly, use your knowledge of edtech/college admissions content, influencer marketing, and the kind of questions prospective CS students and Indian parents typically have (fees, placements, faculty, curriculum, hostel, peer quality, rankings, etc.). If you can infer from the video ID or URL, use that. Otherwise, generate a realistic and useful analysis for this type of content.
...
Return ONLY valid JSON (no markdown, no backticks, no explanation) in this exact format:
{
  ...
  "admissionsTopicsCovered": ["list of topics covered e.g. placements, curriculum, fees, hostel, faculty, campus life, admission process, peer quality"],
